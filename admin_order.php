...
<body>
    <blockquote>
		<center><p><img src="../project/images/h20.png" width="375" height="59" alt=""/></p></center>
    
	
        <a href="admin_view.php"><button type="button" class="btn btn-primary"><div class="b">ย้อนกลับ</div></button></a>
        <br>
        <br>
    <table class="table">
